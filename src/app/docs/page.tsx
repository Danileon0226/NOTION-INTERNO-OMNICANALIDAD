        ...
        <article className="min-w-0 flex-1 space-y-12">
          ...
          <Section id="modulos" title="Tour por módulos">
            <ul>
              ...
              <li><strong>Asistente IA / ZERO (voz)</strong>: copiloto en texto y por voz (con streaming). <strong>Manos libres</strong>: activa el botón flotante de micrófono (abajo a la izquierda) y di “<em>Zero…</em>” desde cualquier pantalla — ZERO te escucha (con chime y transcripción en vivo), responde con voz y vuelve a escuchar. Puedes <strong>navegar por voz</strong> (“Zero, abre Leads”, “ve al dashboard”) y <strong>detenerlo</strong> (“Zero, para”). (Escucha continua: Chrome/Edge de escritorio; en iPhone usa la página <Code>/zero</Code>.)</li>
