...
export const seedConnectors: Connector[] = [
  {
    ...
    description:
      "Sincroniza la bandeja de principal.zeroagency@gmail.com y clasifica los correos en categorías accionables para el dashboard.",
    status: "connected",
  ...
  },
  {
    ...
    name: "Google Drive",
    description:
      "Monta carpetas y archivos compartidos con la agencia. Detecta entregables de clientes como la carpeta 'CONTENIDO GRÁFICO ALCALDÍA'.",
    status: "pending",
