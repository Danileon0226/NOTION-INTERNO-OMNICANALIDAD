...
correo de la agencia** (`principal.zeroagency@gmail.com`) e integraciones omnicanal con
**Gmail, Google Drive, GitHub y Telegram**.
...
El dashboard viene **sembrado con contexto real** extraído de la bandeja de la agencia:
alertas de facturación de Shopify (FME STORE), la carpeta compartida en Drive
*"CONTENIDO GRÁFICO ALCALDÍA"*, métricas SEO de Search Console (selfiemedellin.com),
alertas de seguridad de Google y leads.
